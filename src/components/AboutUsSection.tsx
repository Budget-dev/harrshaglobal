...
export function AboutUsSection() {
  ...
  const services = [
    {
      ...
      description:
        "Developing high-quality infrastructure and real estate projects that enhance communities, support long-term economic growth, and redefine urban landscapes.",
      position: "left",
    },
    {
      ...
      description:
        "Operating cutting-edge facilities to manufacture and supply advanced bulletproof materials that elevate safety standards across defense and civil sectors.",
      position: "left",
    },
    {
      ...
      description:
        "Executing responsible mineral extraction and sustainable mining practices, anchored in ecological preservation and strict regulatory compliance.",
      position: "left",
    },
    {
      ...
      description:
        "Anchored in integrity, we uphold the highest standards of ethical business operations, ensuring transparency and trust in every partnership we forge.",
      position: "right",
    },
    {
      ...
      description:
        "Driven by a core focus on occupational safety and environmental sustainability, minimizing our footprint while maximizing industrial yield.",
      position: "right",
    },
    {
      ...
      description:
        "Leveraging a robust national network to deliver comprehensive industrial solutions efficiently across diverse geographical regions of India.",
      position: "right",
    },
  ]
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="w-full py-24 px-4 bg-gradient-to-b from-[#F2F2EB] to-[#F8F8F2] dark:from-zinc-900 dark:to-zinc-950 text-[#202e44] dark:text-zinc-50 overflow-hidden relative"
    >
      ...
      >
        ...
        <motion.p className="text-center max-w-3xl mx-auto mb-16 text-[#202e44]/80 dark:text-zinc-300 leading-relaxed" variants={itemVariants}>
          Harrshaglobal Pvt Ltd is a diversified enterprise based in Visakhapatnam, Andhra Pradesh, with a strong presence in infrastructure, real estate, mining, and manufacturing. We are committed to delivering impactful solutions across industrial and civil domains – from cutting-edge bulletproof sheet production to responsible mineral extraction and property development.
        </motion.p>
        ...
        {/* CTA Section */}
        <motion.div
          className="mt-20 bg-[#202e44] dark:bg-zinc-800 text-white p-8 rounded-xl flex flex-col md:flex-row items-center justify-between gap-6"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-xl font-medium text-[#202e44] dark:text-zinc-50 group-hover:text-[#88734C] dark:group-hover:text-[#88734C] transition-colors duration-300">
          {title}
        </h3>
      </motion.div>
      <motion.p
        className="text-sm text-[#202e44]/80 dark:text-zinc-300 leading-relaxed pl-12"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    <motion.div
      className="bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm p-6 rounded-xl flex flex-col items-center text-center group hover:bg-white dark:hover:bg-zinc-800 transition-colors duration-300"
      variants={{
    ...
    >
      <motion.div
        className="w-14 h-14 rounded-full bg-[#202e44]/5 dark:bg-[#202e44]/20 flex items-center justify-center mb-4 text-[#88734C] group-hover:bg-[#88734C]/10 transition-colors duration-300"
        whileHover={{ rotate: 360, transition: { duration: 0.8 } }}
      >
        {icon}
      </motion.div>
      <motion.div ref={countRef} className="text-3xl font-bold text-[#202e44] dark:text-zinc-50 flex items-center">
        <motion.span>{displayValue}</motion.span>
        <span>{suffix}</span>
      </motion.div>
      <p className="text-[#202e44]/70 dark:text-zinc-400 text-sm mt-1">{label}</p>
