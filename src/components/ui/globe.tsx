...
export default function Globe({
  ...
  arcs = [],
  className = "",
  // Beautiful realistic deep blue globe colors
  markerColor = [0.1, 0.8, 0.6], // Vibrant teal/green for markers
  baseColor = [0.15, 0.45, 0.9],  // Stunning deep ocean blue
  arcColor = [0.4, 0.7, 1.0],   // Light blue electric arcs
  glowColor = [0.1, 0.3, 0.75],  // Royal blue atmospheric glow
  dark = 1,                      // Enable dark style for realistic lighting contrast
  mapBrightness = 8,
  markerSize = 0.035,
